...
def main_plot(y_true, y_pred):
    dataTrue = [(DT.datetime.strptime('2015-04-27', "%Y-%m-%d"), y_true[0]), 
    (DT.datetime.strptime('2015-04-13', "%Y-%m-%d"), y_true[1]),
    (DT.datetime.strptime('2015-04-13', "%Y-%m-%d"), y_true[2]),
    (DT.datetime.strptime('2015-04-15', "%Y-%m-%d"), y_true[3]),
    (DT.datetime.strptime('2015-04-08', "%Y-%m-%d"), y_true[4]),
    (DT.datetime.strptime('2015-04-07', "%Y-%m-%d"), y_true[5]),
    (DT.datetime.strptime('2015-04-16', "%Y-%m-%d"), y_true[6]),
    (DT.datetime.strptime('2015-04-10', "%Y-%m-%d"), y_true[7]),
    (DT.datetime.strptime('2014-01-02', "%Y-%m-%d"), y_true[8]),
    (DT.datetime.strptime('2014-01-21', "%Y-%m-%d"), y_true[9]),
    (DT.datetime.strptime('2014-02-18', "%Y-%m-%d"), y_true[10]),
    (DT.datetime.strptime('2014-04-21', "%Y-%m-%d"), y_true[11]),
    (DT.datetime.strptime('2014-05-27', "%Y-%m-%d"), y_true[12]),
    (DT.datetime.strptime('2014-07-07', "%Y-%m-%d"), y_true[13]),
    (DT.datetime.strptime('2014-09-02', "%Y-%m-%d"), y_true[14]),
    (DT.datetime.strptime('2014-11-28', "%Y-%m-%d"), y_true[15]),
    (DT.datetime.strptime('2014-12-26', "%Y-%m-%d"), y_true[16]),
    (DT.datetime.strptime('2016-05-11', "%Y-%m-%d"), y_true[17]),
    (DT.datetime.strptime('2016-01-04', "%Y-%m-%d"), y_true[18]),
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), y_true[19]),
    (DT.datetime.strptime('2016-02-16', "%Y-%m-%d"), y_true[20]),
    (DT.datetime.strptime('2016-03-28', "%Y-%m-%d"), y_true[21]),
    (DT.datetime.strptime('2016-05-09', "%Y-%m-%d"), y_true[22]),
    (DT.datetime.strptime('2016-05-13', "%Y-%m-%d"), y_true[23]),
    (DT.datetime.strptime('2016-05-16', "%Y-%m-%d"), y_true[24]),
   

    (DT.datetime.strptime('2015-01-02', "%Y-%m-%d"), y_true[25]), 
    (DT.datetime.strptime('2015-01-20', "%Y-%m-%d"), y_true[26]),
    (DT.datetime.strptime('2015-01-21', "%Y-%m-%d"), y_true[27]), 
    (DT.datetime.strptime('2015-01-22', "%Y-%m-%d"), y_true[28]), 
    (DT.datetime.strptime('2015-02-02', "%Y-%m-%d"), y_true[29]), 
    (DT.datetime.strptime('2015-02-04', "%Y-%m-%d"), y_true[30]), 
    (DT.datetime.strptime('2015-03-19', "%Y-%m-%d"), y_true[31]), 
    (DT.datetime.strptime('2015-03-20', "%Y-%m-%d"), y_true[32]), 
    # (DT.datetime.strptime('2014-01-03', "%Y-%m-%d"), y_true[0]), ###########
    # (DT.datetime.strptime('2014-04-02', "%Y-%m-%d"), y_true[0]), ###########
    # (DT.datetime.strptime('2014-04-04', "%Y-%m-%d"), y_true[0]), ###########
    (DT.datetime.strptime('2014-05-02', "%Y-%m-%d"), y_true[33]), 
    (DT.datetime.strptime('2014-06-03', "%Y-%m-%d"), y_true[34]),
    (DT.datetime.strptime('2014-06-23', "%Y-%m-%d"), y_true[35]), 
    (DT.datetime.strptime('2014-06-24', "%Y-%m-%d"), y_true[36]), 
    (DT.datetime.strptime('2014-07-02', "%Y-%m-%d"), y_true[37]),
    (DT.datetime.strptime('2016-01-05', "%Y-%m-%d"), y_true[38]), 
    (DT.datetime.strptime('2016-01-12', "%Y-%m-%d"), y_true[39]), 
    (DT.datetime.strptime('2016-01-13', "%Y-%m-%d"), y_true[40]),
    (DT.datetime.strptime('2016-01-04', "%Y-%m-%d"), y_true[41]), 
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), y_true[42]),
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), y_true[43]),
    (DT.datetime.strptime('2016-01-21', "%Y-%m-%d"), y_true[44]), 


    (DT.datetime.strptime('2015-01-28', "%Y-%m-%d"), y_true[45]), 
    (DT.datetime.strptime('2015-01-29', "%Y-%m-%d"), y_true[46]), 
    (DT.datetime.strptime('2015-03-23', "%Y-%m-%d"), y_true[47]),
    (DT.datetime.strptime('2015-03-25', "%Y-%m-%d"), y_true[48]), 
    (DT.datetime.strptime('2015-04-02', "%Y-%m-%d"), y_true[49]),
    (DT.datetime.strptime('2015-04-06', "%Y-%m-%d"), y_true[50]), 
    (DT.datetime.strptime('2015-04-06', "%Y-%m-%d"), y_true[51]), 
    (DT.datetime.strptime('2015-05-04', "%Y-%m-%d"), y_true[52]),
    (DT.datetime.strptime('2014-07-03', "%Y-%m-%d"), y_true[53]), 
    (DT.datetime.strptime('2014-07-07', "%Y-%m-%d"), y_true[54]), 
    (DT.datetime.strptime('2014-07-22', "%Y-%m-%d"), y_true[55]), 
    (DT.datetime.strptime('2014-07-14', "%Y-%m-%d"), y_true[56]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), y_true[57]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), y_true[58]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), y_true[59]),
    (DT.datetime.strptime('2014-08-18', "%Y-%m-%d"), y_true[60]),
    (DT.datetime.strptime('2016-02-02', "%Y-%m-%d"), y_true[61]), 
    (DT.datetime.strptime('2016-02-03', "%Y-%m-%d"), y_true[62]), 
    (DT.datetime.strptime('2016-02-04', "%Y-%m-%d"), y_true[63]), 
    (DT.datetime.strptime('2016-02-05', "%Y-%m-%d"), y_true[64]), 
    (DT.datetime.strptime('2016-02-08', "%Y-%m-%d"), y_true[65]),
    (DT.datetime.strptime('2016-02-09', "%Y-%m-%d"), y_true[66]),
    (DT.datetime.strptime('2016-02-10', "%Y-%m-%d"), y_true[67]),


    (DT.datetime.strptime('2015-06-02', "%Y-%m-%d"), y_true[68]), 
    (DT.datetime.strptime('2015-06-03', "%Y-%m-%d"), y_true[69]), 
    (DT.datetime.strptime('2015-06-04', "%Y-%m-%d"), y_true[70]),
    (DT.datetime.strptime('2015-06-15', "%Y-%m-%d"), y_true[71]), 
    (DT.datetime.strptime('2015-06-29', "%Y-%m-%d"), y_true[72]),
    (DT.datetime.strptime('2015-07-20', "%Y-%m-%d"), y_true[73]), 
    (DT.datetime.strptime('2015-10-02', "%Y-%m-%d"), y_true[74]), 
    (DT.datetime.strptime('2015-11-02', "%Y-%m-%d"), y_true[75]),
    (DT.datetime.strptime('2014-07-15', "%Y-%m-%d"), y_true[76]), 
    (DT.datetime.strptime('2014-08-11', "%Y-%m-%d"), y_true[77]),
    (DT.datetime.strptime('2014-08-12', "%Y-%m-%d"), y_true[78]),
    (DT.datetime.strptime('2014-08-15', "%Y-%m-%d"), y_true[79]),
    (DT.datetime.strptime('2014-09-08', "%Y-%m-%d"), y_true[80]),
    (DT.datetime.strptime('2014-09-15', "%Y-%m-%d"), y_true[81]), 
    (DT.datetime.strptime('2014-10-15', "%Y-%m-%d"), y_true[82]),
    (DT.datetime.strptime('2014-12-03', "%Y-%m-%d"), y_true[83]),
    (DT.datetime.strptime('2016-03-04', "%Y-%m-%d"), y_true[84]), 
    (DT.datetime.strptime('2016-03-09', "%Y-%m-%d"), y_true[85]), 
    (DT.datetime.strptime('2016-03-11', "%Y-%m-%d"), y_true[86]), 
    (DT.datetime.strptime('2016-04-04', "%Y-%m-%d"), y_true[87]), 
    (DT.datetime.strptime('2016-04-04', "%Y-%m-%d"), y_true[88]),
    (DT.datetime.strptime('2016-05-02', "%Y-%m-%d"), y_true[89]), 
    (DT.datetime.strptime('2016-05-11', "%Y-%m-%d"), y_true[90]), 
    (DT.datetime.strptime('2016-05-13', "%Y-%m-%d"), y_true[91])]

    ###########################################
    dataPred = [(DT.datetime.strptime('2015-04-27', "%Y-%m-%d"), y_pred[0]),
    (DT.datetime.strptime('2015-04-13', "%Y-%m-%d"), y_pred[1]),
    (DT.datetime.strptime('2015-04-13', "%Y-%m-%d"), y_pred[2]),
    (DT.datetime.strptime('2015-04-15', "%Y-%m-%d"), y_pred[3]),
    (DT.datetime.strptime('2015-04-08', "%Y-%m-%d"), y_pred[4]),
    (DT.datetime.strptime('2015-04-07', "%Y-%m-%d"), y_pred[5]),
    (DT.datetime.strptime('2015-04-16', "%Y-%m-%d"), y_pred[6]),
    (DT.datetime.strptime('2015-04-10', "%Y-%m-%d"), y_pred[7]),
    (DT.datetime.strptime('2014-01-02', "%Y-%m-%d"), y_pred[8]),
    (DT.datetime.strptime('2014-01-21', "%Y-%m-%d"), y_pred[9]),
    (DT.datetime.strptime('2014-02-18', "%Y-%m-%d"), y_pred[10]),
    (DT.datetime.strptime('2014-04-21', "%Y-%m-%d"), y_pred[11]),
    (DT.datetime.strptime('2014-05-27', "%Y-%m-%d"), y_pred[12]),
    (DT.datetime.strptime('2014-07-07', "%Y-%m-%d"), y_pred[13]),
    (DT.datetime.strptime('2014-09-02', "%Y-%m-%d"), y_pred[14]),
    (DT.datetime.strptime('2014-11-28', "%Y-%m-%d"), y_pred[15]),
    (DT.datetime.strptime('2014-12-26', "%Y-%m-%d"), y_pred[16]),
    (DT.datetime.strptime('2016-05-11', "%Y-%m-%d"), y_pred[17]),
    (DT.datetime.strptime('2016-01-04', "%Y-%m-%d"), y_pred[18]),
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), y_pred[19]),
    (DT.datetime.strptime('2016-02-16', "%Y-%m-%d"), y_pred[20]),
    (DT.datetime.strptime('2016-03-28', "%Y-%m-%d"), y_pred[21]),
    (DT.datetime.strptime('2016-05-09', "%Y-%m-%d"), y_pred[22]),
    (DT.datetime.strptime('2016-05-13', "%Y-%m-%d"), y_pred[23]),
    (DT.datetime.strptime('2016-05-16', "%Y-%m-%d"), y_pred[24]),
   

    (DT.datetime.strptime('2015-01-02', "%Y-%m-%d"), y_pred[25]), 
    (DT.datetime.strptime('2015-01-20', "%Y-%m-%d"), y_pred[26]),
    (DT.datetime.strptime('2015-01-21', "%Y-%m-%d"), y_pred[27]), 
    (DT.datetime.strptime('2015-01-22', "%Y-%m-%d"), y_pred[28]), 
    (DT.datetime.strptime('2015-02-02', "%Y-%m-%d"), y_pred[29]), 
    (DT.datetime.strptime('2015-02-04', "%Y-%m-%d"), y_pred[30]), 
    (DT.datetime.strptime('2015-03-19', "%Y-%m-%d"), y_pred[31]), 
    (DT.datetime.strptime('2015-03-20', "%Y-%m-%d"), y_pred[32]), 
    # (DT.datetime.strptime('2014-01-03', "%Y-%m-%d"), y_pred[0]), ###########
    # (DT.datetime.strptime('2014-04-02', "%Y-%m-%d"), y_pred[0]), ###########
    # (DT.datetime.strptime('2014-04-04', "%Y-%m-%d"), y_pred[0]), ###########
    (DT.datetime.strptime('2014-05-02', "%Y-%m-%d"), y_pred[33]), 
    (DT.datetime.strptime('2014-06-03', "%Y-%m-%d"), y_pred[34]),
    (DT.datetime.strptime('2014-06-23', "%Y-%m-%d"), y_pred[35]), 
    (DT.datetime.strptime('2014-06-24', "%Y-%m-%d"), y_pred[36]), 
    (DT.datetime.strptime('2014-07-02', "%Y-%m-%d"), y_pred[37]),
    (DT.datetime.strptime('2016-01-05', "%Y-%m-%d"), y_pred[38]), 
    (DT.datetime.strptime('2016-01-12', "%Y-%m-%d"), y_pred[39]), 
    (DT.datetime.strptime('2016-01-13', "%Y-%m-%d"), y_pred[40]),
    (DT.datetime.strptime('2016-01-04', "%Y-%m-%d"), y_pred[41]), 
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), y_pred[42]),
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), y_pred[43]),
    (DT.datetime.strptime('2016-01-21', "%Y-%m-%d"), y_pred[44]), 


    (DT.datetime.strptime('2015-01-28', "%Y-%m-%d"), y_pred[45]), 
    (DT.datetime.strptime('2015-01-29', "%Y-%m-%d"), y_pred[46]), 
    (DT.datetime.strptime('2015-03-23', "%Y-%m-%d"), y_pred[47]),
    (DT.datetime.strptime('2015-03-25', "%Y-%m-%d"), y_pred[48]), 
    (DT.datetime.strptime('2015-04-02', "%Y-%m-%d"), y_pred[49]),
    (DT.datetime.strptime('2015-04-06', "%Y-%m-%d"), y_pred[50]), 
    (DT.datetime.strptime('2015-04-06', "%Y-%m-%d"), y_pred[51]), 
    (DT.datetime.strptime('2015-05-04', "%Y-%m-%d"), y_pred[52]),
    (DT.datetime.strptime('2014-07-03', "%Y-%m-%d"), y_pred[53]), 
    (DT.datetime.strptime('2014-07-07', "%Y-%m-%d"), y_pred[54]), 
    (DT.datetime.strptime('2014-07-22', "%Y-%m-%d"), y_pred[55]), 
    (DT.datetime.strptime('2014-07-14', "%Y-%m-%d"), y_pred[56]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), y_pred[57]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), y_pred[58]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), y_pred[59]),
    (DT.datetime.strptime('2014-08-18', "%Y-%m-%d"), y_pred[60]),
    (DT.datetime.strptime('2016-02-02', "%Y-%m-%d"), y_pred[61]), 
    (DT.datetime.strptime('2016-02-03', "%Y-%m-%d"), y_pred[62]), 
    (DT.datetime.strptime('2016-02-04', "%Y-%m-%d"), y_pred[63]), 
    (DT.datetime.strptime('2016-02-05', "%Y-%m-%d"), y_pred[64]), 
    (DT.datetime.strptime('2016-02-08', "%Y-%m-%d"), y_pred[65]),
    (DT.datetime.strptime('2016-02-09', "%Y-%m-%d"), y_pred[66]),
    (DT.datetime.strptime('2016-02-10', "%Y-%m-%d"), y_pred[67]),


    (DT.datetime.strptime('2015-06-02', "%Y-%m-%d"), y_pred[68]), 
    (DT.datetime.strptime('2015-06-03', "%Y-%m-%d"), y_pred[69]), 
    (DT.datetime.strptime('2015-06-04', "%Y-%m-%d"), y_pred[70]),
    (DT.datetime.strptime('2015-06-15', "%Y-%m-%d"), y_pred[71]), 
    (DT.datetime.strptime('2015-06-29', "%Y-%m-%d"), y_pred[72]),
    (DT.datetime.strptime('2015-07-20', "%Y-%m-%d"), y_pred[73]), 
    (DT.datetime.strptime('2015-10-02', "%Y-%m-%d"), y_pred[74]), 
    (DT.datetime.strptime('2015-11-02', "%Y-%m-%d"), y_pred[75]),
    (DT.datetime.strptime('2014-07-15', "%Y-%m-%d"), y_pred[76]), 
    (DT.datetime.strptime('2014-08-11', "%Y-%m-%d"), y_pred[77]),
    (DT.datetime.strptime('2014-08-12', "%Y-%m-%d"), y_pred[78]),
    (DT.datetime.strptime('2014-08-15', "%Y-%m-%d"), y_pred[79]),
    (DT.datetime.strptime('2014-09-08', "%Y-%m-%d"), y_pred[80]),
    (DT.datetime.strptime('2014-09-15', "%Y-%m-%d"), y_pred[81]), 
    (DT.datetime.strptime('2014-10-15', "%Y-%m-%d"), y_pred[82]),
    (DT.datetime.strptime('2014-12-03', "%Y-%m-%d"), y_pred[83]),
    (DT.datetime.strptime('2016-03-04', "%Y-%m-%d"), y_pred[84]), 
    (DT.datetime.strptime('2016-03-09', "%Y-%m-%d"), y_pred[85]), 
    (DT.datetime.strptime('2016-03-11', "%Y-%m-%d"), y_pred[86]), 
    (DT.datetime.strptime('2016-04-04', "%Y-%m-%d"), y_pred[87]), 
    (DT.datetime.strptime('2016-04-04', "%Y-%m-%d"), y_pred[88]),
    (DT.datetime.strptime('2016-05-02', "%Y-%m-%d"), y_pred[89]), 
    (DT.datetime.strptime('2016-05-11', "%Y-%m-%d"), y_pred[90]), 
    (DT.datetime.strptime('2016-05-13', "%Y-%m-%d"), y_pred[91])] 
...
def residual_plot(list_of_errors):
    ###########################################
    residual = [(DT.datetime.strptime('2015-04-27', "%Y-%m-%d"), list_of_errors[0]),
    (DT.datetime.strptime('2015-04-13', "%Y-%m-%d"), list_of_errors[1]),
    (DT.datetime.strptime('2015-04-13', "%Y-%m-%d"), list_of_errors[2]),
    (DT.datetime.strptime('2015-04-15', "%Y-%m-%d"), list_of_errors[3]),
    (DT.datetime.strptime('2015-04-08', "%Y-%m-%d"), list_of_errors[4]),
    (DT.datetime.strptime('2015-04-07', "%Y-%m-%d"), list_of_errors[5]),
    (DT.datetime.strptime('2015-04-16', "%Y-%m-%d"), list_of_errors[6]),
    (DT.datetime.strptime('2015-04-10', "%Y-%m-%d"), list_of_errors[7]),
    (DT.datetime.strptime('2014-01-02', "%Y-%m-%d"), list_of_errors[8]),
    (DT.datetime.strptime('2014-01-21', "%Y-%m-%d"), list_of_errors[9]),
    (DT.datetime.strptime('2014-02-18', "%Y-%m-%d"), list_of_errors[10]),
    (DT.datetime.strptime('2014-04-21', "%Y-%m-%d"), list_of_errors[11]),
    (DT.datetime.strptime('2014-05-27', "%Y-%m-%d"), list_of_errors[12]),
    (DT.datetime.strptime('2014-07-07', "%Y-%m-%d"), list_of_errors[13]),
    (DT.datetime.strptime('2014-09-02', "%Y-%m-%d"), list_of_errors[14]),
    (DT.datetime.strptime('2014-11-28', "%Y-%m-%d"), list_of_errors[15]),
    (DT.datetime.strptime('2014-12-26', "%Y-%m-%d"), list_of_errors[16]),
    (DT.datetime.strptime('2016-05-11', "%Y-%m-%d"), list_of_errors[17]),
    (DT.datetime.strptime('2016-01-04', "%Y-%m-%d"), list_of_errors[18]),
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), list_of_errors[19]),
    (DT.datetime.strptime('2016-02-16', "%Y-%m-%d"), list_of_errors[20]),
    (DT.datetime.strptime('2016-03-28', "%Y-%m-%d"), list_of_errors[21]),
    (DT.datetime.strptime('2016-05-09', "%Y-%m-%d"), list_of_errors[22]),
    (DT.datetime.strptime('2016-05-13', "%Y-%m-%d"), list_of_errors[23]),
    (DT.datetime.strptime('2016-05-16', "%Y-%m-%d"), list_of_errors[24]),
   

    (DT.datetime.strptime('2015-01-02', "%Y-%m-%d"), list_of_errors[25]), 
    (DT.datetime.strptime('2015-01-20', "%Y-%m-%d"), list_of_errors[26]),
    (DT.datetime.strptime('2015-01-21', "%Y-%m-%d"), list_of_errors[27]), 
    (DT.datetime.strptime('2015-01-22', "%Y-%m-%d"), list_of_errors[28]), 
    (DT.datetime.strptime('2015-02-02', "%Y-%m-%d"), list_of_errors[29]), 
    (DT.datetime.strptime('2015-02-04', "%Y-%m-%d"), list_of_errors[30]), 
    (DT.datetime.strptime('2015-03-19', "%Y-%m-%d"), list_of_errors[31]), 
    (DT.datetime.strptime('2015-03-20', "%Y-%m-%d"), list_of_errors[32]), 
    # (DT.datetime.strptime('2014-01-03', "%Y-%m-%d"), list_of_errors[0]), ###########
    # (DT.datetime.strptime('2014-04-02', "%Y-%m-%d"), list_of_errors[0]), ###########
    # (DT.datetime.strptime('2014-04-04', "%Y-%m-%d"), list_of_errors[0]), ###########
    (DT.datetime.strptime('2014-05-02', "%Y-%m-%d"), list_of_errors[33]), 
    (DT.datetime.strptime('2014-06-03', "%Y-%m-%d"), list_of_errors[34]),
    (DT.datetime.strptime('2014-06-23', "%Y-%m-%d"), list_of_errors[35]), 
    (DT.datetime.strptime('2014-06-24', "%Y-%m-%d"), list_of_errors[36]), 
    (DT.datetime.strptime('2014-07-02', "%Y-%m-%d"), list_of_errors[37]),
    (DT.datetime.strptime('2016-01-05', "%Y-%m-%d"), list_of_errors[38]), 
    (DT.datetime.strptime('2016-01-12', "%Y-%m-%d"), list_of_errors[39]), 
    (DT.datetime.strptime('2016-01-13', "%Y-%m-%d"), list_of_errors[40]),
    (DT.datetime.strptime('2016-01-04', "%Y-%m-%d"), list_of_errors[41]), 
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), list_of_errors[42]),
    (DT.datetime.strptime('2016-01-19', "%Y-%m-%d"), list_of_errors[43]),
    (DT.datetime.strptime('2016-01-21', "%Y-%m-%d"), list_of_errors[44]), 


    (DT.datetime.strptime('2015-01-28', "%Y-%m-%d"), list_of_errors[45]), 
    (DT.datetime.strptime('2015-01-29', "%Y-%m-%d"), list_of_errors[46]), 
    (DT.datetime.strptime('2015-03-23', "%Y-%m-%d"), list_of_errors[47]),
    (DT.datetime.strptime('2015-03-25', "%Y-%m-%d"), list_of_errors[48]), 
    (DT.datetime.strptime('2015-04-02', "%Y-%m-%d"), list_of_errors[49]),
    (DT.datetime.strptime('2015-04-06', "%Y-%m-%d"), list_of_errors[50]), 
    (DT.datetime.strptime('2015-04-06', "%Y-%m-%d"), list_of_errors[51]), 
    (DT.datetime.strptime('2015-05-04', "%Y-%m-%d"), list_of_errors[52]),
    (DT.datetime.strptime('2014-07-03', "%Y-%m-%d"), list_of_errors[53]), 
    (DT.datetime.strptime('2014-07-07', "%Y-%m-%d"), list_of_errors[54]), 
    (DT.datetime.strptime('2014-07-22', "%Y-%m-%d"), list_of_errors[55]), 
    (DT.datetime.strptime('2014-07-14', "%Y-%m-%d"), list_of_errors[56]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), list_of_errors[57]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), list_of_errors[58]),
    (DT.datetime.strptime('2014-08-04', "%Y-%m-%d"), list_of_errors[59]),
    (DT.datetime.strptime('2014-08-18', "%Y-%m-%d"), list_of_errors[60]),
    (DT.datetime.strptime('2016-02-02', "%Y-%m-%d"), list_of_errors[61]), 
    (DT.datetime.strptime('2016-02-03', "%Y-%m-%d"), list_of_errors[62]), 
    (DT.datetime.strptime('2016-02-04', "%Y-%m-%d"), list_of_errors[63]), 
    (DT.datetime.strptime('2016-02-05', "%Y-%m-%d"), list_of_errors[64]), 
    (DT.datetime.strptime('2016-02-08', "%Y-%m-%d"), list_of_errors[65]),
    (DT.datetime.strptime('2016-02-09', "%Y-%m-%d"), list_of_errors[66]),
    (DT.datetime.strptime('2016-02-10', "%Y-%m-%d"), list_of_errors[67]),


    (DT.datetime.strptime('2015-06-02', "%Y-%m-%d"), list_of_errors[68]), 
    (DT.datetime.strptime('2015-06-03', "%Y-%m-%d"), list_of_errors[69]), 
    (DT.datetime.strptime('2015-06-04', "%Y-%m-%d"), list_of_errors[70]),
    (DT.datetime.strptime('2015-06-15', "%Y-%m-%d"), list_of_errors[71]), 
    (DT.datetime.strptime('2015-06-29', "%Y-%m-%d"), list_of_errors[72]),
    (DT.datetime.strptime('2015-07-20', "%Y-%m-%d"), list_of_errors[73]), 
    (DT.datetime.strptime('2015-10-02', "%Y-%m-%d"), list_of_errors[74]), 
    (DT.datetime.strptime('2015-11-02', "%Y-%m-%d"), list_of_errors[75]),
    (DT.datetime.strptime('2014-07-15', "%Y-%m-%d"), list_of_errors[76]), 
    (DT.datetime.strptime('2014-08-11', "%Y-%m-%d"), list_of_errors[77]),
    (DT.datetime.strptime('2014-08-12', "%Y-%m-%d"), list_of_errors[78]),
    (DT.datetime.strptime('2014-08-15', "%Y-%m-%d"), list_of_errors[79]),
    (DT.datetime.strptime('2014-09-08', "%Y-%m-%d"), list_of_errors[80]),
    (DT.datetime.strptime('2014-09-15', "%Y-%m-%d"), list_of_errors[81]), 
    (DT.datetime.strptime('2014-10-15', "%Y-%m-%d"), list_of_errors[82]),
    (DT.datetime.strptime('2014-12-03', "%Y-%m-%d"), list_of_errors[83]),
    (DT.datetime.strptime('2016-03-04', "%Y-%m-%d"), list_of_errors[84]), 
    (DT.datetime.strptime('2016-03-09', "%Y-%m-%d"), list_of_errors[85]), 
    (DT.datetime.strptime('2016-03-11', "%Y-%m-%d"), list_of_errors[86]), 
    (DT.datetime.strptime('2016-04-04', "%Y-%m-%d"), list_of_errors[87]), 
    (DT.datetime.strptime('2016-04-04', "%Y-%m-%d"), list_of_errors[88]),
    (DT.datetime.strptime('2016-05-02', "%Y-%m-%d"), list_of_errors[89]), 
    (DT.datetime.strptime('2016-05-11', "%Y-%m-%d"), list_of_errors[90]), 
    (DT.datetime.strptime('2016-05-13', "%Y-%m-%d"), list_of_errors[91])] 
