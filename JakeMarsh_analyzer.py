...
from JakeMarsh_neuralNetwork import NeuralNetwork
...
# Andreas-MacBook-Pro-2:StockPredictor andreamelendezcuesta$ python JakeMarsh_analyzer.py > JakeMarsh_output.txt
# and the output is poured in JakeMarsh_output.txt
...
#output saved in JakeMarsh_output.txt
# Andreas-MacBook-Pro-2:StockPredictor andreamelendezcuesta$ python JakeMarsh_analyzer.py
# error 4.77852
# error 3.72645
# error 3.72645
# error 3.72645
...
# error 3.72645
# error 3.72645
# ([711.798, 701.64, 722.87], '->', [0.9578141690249979])
# {'price': 717.3385987021002, 'time': 3.56820011138916}
